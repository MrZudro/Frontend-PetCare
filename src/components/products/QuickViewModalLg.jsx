...
/**
 * Componente Modal de Vista Rápida (Con info: Categoría, Tipo, Marca)
 */
                    ...
                    <div className="grid w-full grid-cols-1 items-start gap-x-6 gap-y-8 sm:grid-cols-12 lg:gap-x-8">
                        ...
                        <div className="sm:col-span-8 lg:col-span-7">
                            ...
                            <section aria-labelledby="information-heading" className="mt-4 border-b pb-4">
                                ...
                                {/* MOVIDO: Información de Categoría, Marca y Tipo ahora en este bloque */}
                                <div className='mt-3 text-sm text-gray-600 space-y-1'>
                                    ...
                                    {product.type && (
                                        <p>
                                            <span className='font-semibold text-gray-800'>Tipo:</span> {product.type}
                                        </p>
                                    )}
                                    {product.brand && (
                                        <p>
                                            <span className='font-semibold text-gray-800'>Marca:</span> {product.brand}
                                        </p>
                                    )}
                                </div>
                            </section>
                            ...
                            {/* Opciones (Colores y Tallas) - Se mantienen igual */}
